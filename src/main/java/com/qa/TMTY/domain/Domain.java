...
public enum Domain {
	...
	LOGIN("Access information on logins"), ORDERS("To acces information on the orders table"),
	DELIVERIES("To access the delivery filing system"), STOP("To close the application");
